    ...
    <header class="flex">
        <nav class="nav flex">
            <ul class="flex">
                ...
                <li class="flex"><img src="../assets/icons/paw-solid.ico" alt="icono_huella" class="icon"><a href="usuarios_administracion.php?tareaAdmin=verUsersAdmin" class="color">Users/Adm</a></li>
