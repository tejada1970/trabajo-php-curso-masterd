...
# Completa las siguientes variables con la información de tu entorno local:
...
<?php
   ...
   const USUARIO = "root"; #// Cambia 'nombre_usuario' por el nombre de usuario de tu base de datos.
   const PASSWORD = ""; #// Cambia 'contraseña' por la contraseña de tu base de datos.
?>